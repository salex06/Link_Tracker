...
class GitHubPersonalStorageClientTest {
    ...
    void getUpdates_WhenRepositoryWasUpdated_ThenReturnUpdateMessage() {
        ...
        gitHubPersonalStorageClient = new GitHubPersonalStorageClient(
                x -> String.format("http://localhost:" + port + "/octocat/Hello-World/"),
                restClient,
                stabilityProperties);
                        ...
                        .willReturn(
                                aResponse()
                                        ...
                                        .withBody(
                                                """
                                { "id": 1296269,
                                "node_id": "MDEwOlJlcG9zaXRvcnkxMjk2MjY5", "name": "Hello-World", "full_name":
                                "octocat/Hello-World", "private": false, "owner": { "login": "octocat", "id": 583231,
                                "node_id": "MDQ6VXNlcjU4MzIzMQ==", "avatar_url":
                                ...
                                "tags_url": "https://api.github.com/repos/octocat/Hello-World/tags", "blobs_url":
                                ...
                                "merges_url": "https://api.github.com/repos/octocat/Hello-World/merges", "archive_url":
                                ...
                                "created_at": "2011-01-26T19:01:12Z", "updated_at": "+999999999-12-31T23:59:59Z",
                                "pushed_at": "2024-08-20T23:54:42Z", "git_url": "git://github.com/octocat/Hello-World.git",
                                "ssh_url": "git@github.com:octocat/Hello-World.git", "clone_url":
                                "https://github.com/octocat/Hello-World.git", "svn_url":
                                "https://github.com/octocat/Hello-World", "homepage": "", "size": 1,
                                "stargazers_count": 2859, "watchers_count": 2859, "language": null, "has_issues":
                                true, "has_projects": true, "has_downloads": true, "has_wiki": true, "has_pages":
                                false, "has_discussions": false, "forks_count": 2723, "mirror_url": null, "archived":
                                false, "disabled": false, "open_issues_count": 1557, "license": null, "allow_forking":
                                true, "is_template": false, "web_commit_signoff_required": false, "topics": [],
                                "visibility": "public", "forks": 2723, "open_issues": 1557, "watchers": 2859,
                                "default_branch": "master", "temp_clone_token": null, "network_count": 2723,
    ...
    void getUpdates_WhenRepositoryNotFound_ThenReturnEmptyList() {
        restClient = RestClient.builder().baseUrl("http://localhost:" + port).build();
        gitHubPersonalStorageClient = new GitHubPersonalStorageClient(
                x -> String.format("http://localhost:" + port + "/octocat/Hello-Worldd"),
                restClient,
                stabilityProperties);
