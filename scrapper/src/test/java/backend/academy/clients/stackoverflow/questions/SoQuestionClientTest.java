...
class SoQuestionClientTest {
    ...
    void getUpdates_WhenQuestionWasUpdated_ThenReturnUpdateMessage() {
        ...
        String expectedMessage1 =
                """
            Новый комментарий к вопросу How do I parse a string to a float or int?\r
            Автор: InfiniteStack\r
            Время создания: 08-02-2277 13:34 (UTC)\r
        ...
        String expectedMessage3 =
                """
            Новый комментарий к вопросу How do I parse a string to a float or int?\r
            Автор: Dendi Handian\r
            Время создания: 02-09-2275 21:40 (UTC)\r
        ...
        String expectedMessage4 =
                """
            Новый комментарий к вопросу How do I parse a string to a float or int?\r
            Автор: Joseph Prosper\r
            Время создания: 15-10-2277 19:53 (UTC)\r
            Превью: Body example""";
