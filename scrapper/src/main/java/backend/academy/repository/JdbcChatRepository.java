...
public class JdbcChatRepository {
    ...
    @Modifying
    @Transactional
    public void saveTheChatLink(Long chatId, Long linkId) {
    ...
    @Modifying
    @Transactional
    public void saveTag(Long linkId, Long chatId, String tagValue) {
    ...
    @Modifying
    @Transactional
    public void saveFilter(Long linkId, Long chatId, String filterValue) {
    ...
    @Modifying
    @Transactional
    public JdbcLink saveLink(@Param("linkValue") String linkValue) {
        String sql = "INSERT INTO link(link_value) VALUES (:linkValue)";

        MapSqlParameterSource params = new MapSqlParameterSource();
        params.addValue("linkValue", linkValue);

        return namedJdbcTemplate.queryForObject(sql, params, JdbcLink.class);
    }
}
